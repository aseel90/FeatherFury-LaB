(() => {
  ...
  loadScript('patch-runner.js?v=3').then(async ok => {
    ...
    const manifestOk = await loadScript('patch-manifest.js?v=26');
    ...
    // Final World 2 visual pass. v2 bypasses stale mobile cache and installs after all manifest patches.
    await loadScript('w2-ice-ground-skeletons-v1.js?v=2');
    releaseBootstrapGate();
  });
})();