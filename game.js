(() => {
  ...
  loadScript('patch-runner.js?v=3').then(ok => {
    ...
    loadScript('patch-manifest.js?v=18').then(manifestOk => {
      if (!manifestOk) return window.__FF_START_LEGACY_PATCH_CHAIN__();
      loadScript('hero-blue-effects-v1.js?v=1');
    });
  });
})();