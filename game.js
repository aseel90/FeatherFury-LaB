(() => {
  ...
  async function installFinalCharacterStack() {
    ...
    await loadScript('world1-phase2-owl-dialogue-v3.js?v=1');
    await loadScript('world1-owl-dialogue-layer-fix-v1.js?v=1');
  }
