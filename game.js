(() => {
  ...
  async function installFinalCharacterStack() {
    ...
    await loadScript('world1-cursed-obstacle-asset-top-b.js?v=2');
    await loadScript('world1-cursed-obstacle-asset-bottom-a.js?v=2');
    await loadScript('world1-cursed-obstacles-v4.js?v=2');
  }
