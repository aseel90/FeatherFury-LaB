(() => {
  ...
  async function installFinalCharacterStack() {
    ...
    await loadScript('world1-crow-contrast-v1.js?v=1');
    ...
    await loadScript('world1-classic-enhanced-background-v1.js?v=1');
    await loadScript('world1-ground-obstacle-polish-v2.js?v=1');
  }
