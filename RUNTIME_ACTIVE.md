...
- `startup-menu-guard-v1.js` — removed from boot; startup state is owned by the approved runtime loader

The executable source of truth is the `ACTIVE_PATCHES` / `RETIRED_PATCHES` map in `game.js`.
