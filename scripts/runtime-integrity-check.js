...
if (!/game\.js\?v=2\.4\.6/.test(index)) fail('index.html is not pinned to approved game.js v2.4.6');
...
if (!/ui-runtime-boot-v1\.js\?v=3/.test(index)) fail('post-runtime UI boot loader is not active');
...
if (!game.includes("'pause-hud-polish-v2.js?v=3'")) fail('pause polish cache/version is not current');
const uiBoot = read('ui-runtime-boot-v1.js');
for (const token of ['__FF_RUNTIME_APPROVED_STACK__','__FF_MENU_UI_READY__','ui-world-select-v1.js?v=8','ui-main-menu-v3.js?v=5','ui-hud-v1.js?v=4']) {
