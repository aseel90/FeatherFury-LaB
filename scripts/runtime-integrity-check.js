...
if (!/fever-bar-container[\s\S]*top:calc\(max\(env\(safe-area-inset-top\),0px\) \+ 61px\)/i.test(runtimeFixCss)) fail('compact HUD must place Fever above the ability chip');
