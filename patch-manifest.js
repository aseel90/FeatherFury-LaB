(() => {
  ...
  const plan = {
    ...
    entries: [
      ...
      { id:'w2-environment-assets-v1',src:'w2-environment-assets-v1.js?v=1',dependsOn:['stable-runtime'],readyTimeout:2500,ready:()=>!!window.__FF_W2_ENV_ASSETS_V1_READY__ },
      { id:'w2-visuals-v1',src:'w2-visuals-v1.js?v=2',dependsOn:['w2-environment-assets-v1'],readyTimeout:3500,ready:()=>!!window.game?.__w2VisualsV1Installed },
