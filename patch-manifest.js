(() => {
  ...
  const plan = {
    ...
    entries: [
      ...
      { id:'victory-screen-fix-v1',src:'victory-screen-fix-v1.js?v=1',dependsOn:['w2-boss-tuning-v8'],readyTimeout:2500,ready:()=>!!window.game?.__victoryScreenFixV1Installed },
