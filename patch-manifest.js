(() => {
  ...
  const plan = {
    ...
    entries: [
      ...
      { id: 'w2-boss-orb-v4', src: 'w2-boss-orb-v4.js?v=1', dependsOn: ['w2-boss-polish-v2'], readyTimeout: 3500, ready: () => !!window.game?.__w2BossOrbV4Installed },
      { id: 'w2-boss-combat-v5', src: 'w2-boss-combat-v5.js?v=1', dependsOn: ['w2-boss-orb-v4'], readyTimeout: 3500, ready: () => !!window.game?.__w2BossCombatV5Installed },
      { id: 'victory-screen-fix-v1', src: 'victory-screen-fix-v1.js?v=1', dependsOn: ['w2-boss-combat-v5', 'revive-core-fix-v1'], readyTimeout: 2500, ready: () => !!window.game?.__victoryScreenFixV1Installed },
  ...
  window.PatchRunner.run(plan).then(() => { releaseBootGate(); }).catch(error => {
    releaseBootGate();
