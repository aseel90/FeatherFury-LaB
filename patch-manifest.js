(() => {
  ...
  const plan = {
    ...
    entries: [
      ...
      { id:'hero-blue-ninja-v1',src:'hero-blue-ninja-v1.js?v=2',dependsOn:['stable-runtime'],ready:()=>!!window.game?.__heroBlueNinjaV1Installed },
      { id:'hero-static-smooth-v2',src:'hero-static-smooth-v2.js?v=1',dependsOn:['hero-blue-ninja-v1'],ready:()=>!!window.game?.__heroStaticSmoothV2Installed },
      { id:'hero-blue-effects-v1',src:'hero-blue-effects-v1.js?v=3',dependsOn:['hero-static-smooth-v2'],ready:()=>!!window.game?.__heroBlueEffectsV1Installed },
      { id:'fierce-falcon-v1',src:'fierce-falcon-v1.js?v=3',dependsOn:['hero-blue-effects-v1'],ready:()=>!!window.game?.__fierceFalconV1Installed },
      { id:'skin-routing-hardfix-v2',src:'skin-routing-hardfix-v2.js?v=2',dependsOn:['fierce-falcon-v1'],ready:()=>!!window.game?.__skinRoutingHardfixV2Installed },
      { id:'character-roster-v1',src:'character-roster-v1.js?v=2',dependsOn:['skin-routing-hardfix-v2'],ready:()=>!!window.game?.__characterRosterV1Installed },
      { id:'character-abilities-v2',src:'character-abilities-v2.js?v=2',dependsOn:['character-roster-v1'],ready:()=>!!window.game?.__characterAbilitiesV2Installed },
      { id:'mountain-eagle-stability-v3',src:'mountain-eagle-stability-v3.js?v=1',dependsOn:['character-abilities-v2'],ready:()=>!!window.game?.__mountainEagleStabilityV3Installed },
      { id:'character-ability-ui-v1',src:'character-ability-ui-v1.js?v=1',dependsOn:['mountain-eagle-stability-v3'],ready:()=>!!window.game?.__characterAbilityUiV1Installed },
      { id:'character-ability-fx-v1',src:'character-ability-fx-v1.js?v=1',dependsOn:['character-ability-ui-v1'],ready:()=>!!window.game?.__characterAbilityFxV1Installed },
      { id:'world1-qa-fix-v2',src:'world1-qa-fix-v2.js?v=1',dependsOn:['character-ability-fx-v1'],ready:()=>!!window.game?.__ffWorld1QaFixV2Installed },
      { id:'owl-guardian-v2-final',src:'owl-guardian-v2.js?v=2',dependsOn:['world1-qa-fix-v2'],ready:()=>!!window.game?.__ffOwlGuardianV2Installed },
