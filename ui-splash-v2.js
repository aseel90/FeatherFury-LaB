...
const A=window.__FF_SPLASH_PNG_V2__; if(!A){console.warn('[FeatherFury] splash PNG assets missing');return;}
...
s.innerHTML=`
  <img class="ff2-bg" src="${A.background}" alt="" draggable="false">
...
window.addEventListener('pagehide',()=>clearInterval(tick),{once:true});window.__FF_SPLASH_V2__={version:'2.0.0-png',mark,finish,get progress(){return progress;}};
})();
